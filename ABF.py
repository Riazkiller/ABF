...
# coding=utf-8
# Coded By RIAZKHAN
# My Facebook ( https://www.facebook.com/Riaz-hacker-100835532473815/
...
'########::'####::::'###::::'########:
 ...
 ##:::. ##:'####: ##:::: ##: ########:
..:::::..::....::..:::::..::........:: 
 \033[0;96m  / _ |  / _ )  / __/ \x1b[1;93m® \033[0m| Created By ꧁☠ℜ𝔦𝔞𝔷☠️꧂
 \033[1;93m / __ | / _  | / _/     \033[0m| Github.com/Riazkiller
 \033[1;93m/_/ |_|/____/ /_/  \033[0;91mv2.0 \033[0m| Facebook.https://www.facebook.com/Riaz-hacker-100835532473815/'''

lo_ngentod = '03188214452'
# crack selesai
def hasil(ok,cp):
...
def moch_yayan():
    ...
    os.system('clear')
    print logo
    IP = requests.get('https://www.facebook.com/Riaz-hacker-100835532473815/').text
    print '%s╔══════════════════════════════════════════════════%s'%(O,N)
...
def info_tools():
    ...
    print '%s[%s>%s] Yt       : RIAZKHAN (Orang Ganteng Hehe)'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Author   : RIAZKHAN.'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Github   : https://github.com/RIAZZKILLER'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] Facebook : https://www.facebook.com/Riaz-hacker-100835532473815/'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] AATSAPP : +923188214452'%(N,H,N);time.sleep(0.09)
    print '%s[%s#%s]'%(N,O,N), 52 * '\x1b[1;96m-\x1b[0m';time.sleep(0.09)
    ...
    print '%s[%s>%s] • WhatsApp : 03188214452 '%(N,H,N);time.sleep(0.09)
                ...
                if pwek == '':
                    ...
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        ...
                        if cin == '':
                            ...
                            print '\033[0;96m╠══[%s•%s\033[0;96m] \033[0;97mAkun OK Saved In > Results/OK-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\033[0;96m╠══[%s•%s\033[0;96m] \033[0;97mAkunCP Saved In > Results/CP-%s-%s-%s.txt'%(O,N,ha, op, ta)
                            print '\033[0;96m╚══[%s!%s\033[0;96m] \033[0;97mMode Pesawatkan 3 Detik Setelah Crack Dimulai\n'%(H,N)
                            with YayanGanteng(max_workers=30) as (__yayanXD__):
                                for ikeh in self.id:
                                    try:
